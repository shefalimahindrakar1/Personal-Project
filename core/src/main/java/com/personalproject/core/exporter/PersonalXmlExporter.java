package com.personalproject.core.exporter;
...
public class PersonalXmlExporter implements ModelExporter {
    private static final Logger LOG = LoggerFactory.getLogger(PersonalXmlExporter.class);
    @Override
