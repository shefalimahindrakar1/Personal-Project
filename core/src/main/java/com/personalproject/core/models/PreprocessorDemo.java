...
public class PreprocessorDemo implements Preprocessor {
    public static final Logger LOG = LoggerFactory.getLogger(PreprocessorDemo.class);
    ...
    String path1 = "/content/personalproject/us/en/schedulerdemo/jcr:content/root/container/container/schedulerdemo";
